...
SECRET_KEY = 'django-insecure-hm48-p0vsj@pg=2u6!t9a8la9&i5d@(1@c+)!ipzffudugm8_)'
...
MIDDLEWARE = [
    ...
    # 'hr.LoginCheckMiddleWare.LoginCheckMiddleWare',
    #'hr.middleware.LoginCheckMiddleWare',
]
...
AUTHENTICATION_BACKENDS = ['hr.EmailBackend.EmailBackend']
APPEND_SLASH = False
